  ...
  return (
    ...
    >
      <div className="mx-auto px-10 py-4">
        <h1 className="text-5xl text-red-600 font-bold text-center mb-5">
          Meet Our Team
        </h1>
        <div className="md:flex items-center justify-around">
          ...
          <div className="left text-center md:text-left md:w-1/2 md:ml-10">
            ...
            <Link href="/Team">
              <button className="bg-blue-500 hover:bg-blue-600 text-white py-3 px-8 rounded-lg border border-black shadow-md">
                See More
              </button>
            </Link>
          </div>
