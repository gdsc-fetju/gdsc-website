  ...
  return (
    ...
    >
      <div className="bg-[url(/bac.svg)] p-20 flex flex-col items-center mx-auto ">
        ...
        <button
          className="mt-4 px-6 py-3 bg-orange-500 text-white text-md rounded-xl flex items-center active:ring-2 hover:bg-orange-600 transition-all font-mulish font-bold"
          onClick={() =>
            (window.location.href = "https://discord.gg/H94GW8APQF")
          }
        >
          Get Started !
        </button>
