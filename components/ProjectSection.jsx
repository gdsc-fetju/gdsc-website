    ...
    >
      <div className="md:bg-[url(/projectbg.svg)] bg-center p-10 md:p-20 flex flex-col items-center mx-auto ">
        ...
        <Link href="https://discord.gg/H94GW8APQF" target="_blank">
          <button className="mt-4 px-6 py-3 bg-google-blue text-white text-md rounded-xl flex items-center active:ring-2 hover:bg-blue-500 transition-all font-mulish font-bold">
            Get Started!
          </button>
        </Link>
      </div>
